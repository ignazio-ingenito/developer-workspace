> **Archived 2026-08-12.** Historical design for the availability-first transition. Superseded by current `main` after PR #18/#19 and the Homelab runtime cutover #709. Do not use this file as current operational guidance.
